...
public interface JavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#mainDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterMainDeclaration( JavaParser.MainDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#mainDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitMainDeclaration( JavaParser.MainDeclarationContext ctx);
	/**
